var jon = 
{
  ...
  "Info": "Voici notre API, version 1-25d, 6 days left",
  ...
  "Tables": {
      ...
      "Evenement": {
          ...
          "POST": {
              "Ajouter_Un": "/addEvent/<idEvent>/<nom>/<lieu>/<nbEquipes>/<debut>/<fin> :: [{ res: ___ , err: ___ }]",
              "Metre_A_Jour": "/updateEvent/<idEvent>/<nom>/<lieu>/<nbEquipes>/<debut>/<fin> :: [{ res: ___ , err: ___ }]",
      ...
      "Matchs": {
          ...
          "POST": {
              ...
              "Envoyer_Resultat_Match": "/compileMatchScore/<idMatch>/<pointsA>/<penalitesA>/<pointsB>/<penalitesB> :: [{ res: ___ , err: ___ }]",
